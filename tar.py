...
class TarParser:
    ...
    def _parse_header(hdr):
        ...
        file_size = int(b'0' + header[4].strip(b'\x00'),
                        8)
...
def main():
    ...
    parser.add_argument('-l', '--list', action='store_true',
                        dest='ls', help='list the contents of an archive')
    parser.add_argument('-x', '--extract', action='store_true',
                        dest='extract', help='extract files from an archive')
